        ...
        <div className="it19184722-myForm-adminDashboard">
            ...
            <div className="it19184722-headerSection">
                <button onClick={pdf} className="btn it19184722-trans-green-btn">
                    ...
                    <span className="spinner-border spinner-border-sm" id="loading" role="status" aria-hidden="true" style={{display:'none'}}></span>
                Download
                </button>
                            ...
                            return(
                                <tr key={students._id} className="it19184722-tr">
                                    ...
                                    <td className="it19184722-td">
                                        <Link className="btn it19184722-green-btn it19184722-mybtn" to={`/admin/studentmng/viewstudents/edit/${students._id}`}>
                                        ...
                                        <button onClick={() => deleteStudent(students._id, students.fname, students.lname)} className="btn btn-danger it19184722-mybtn it19184722-red-btn ">
